...
-- Создание таблицы витрины данных для заказчиков
CREATE TABLE IF NOT EXISTS dwh.customer_report_datamart (
    ...
    customer_spent NUMERIC(15,2) NOT NULL, -- сумма, которую потратил заказчик
    ...
    order_count BIGINT NOT NULL, -- количество заказов у заказчика за месяц
    avg_order_price NUMERIC(10,2) NOT NULL, -- средняя стоимость одного заказа у заказчика за месяц
    median_order_completion_time NUMERIC(10,1) NOT NULL, -- медианное время в днях от момента создания заказа до его завершения за месяц
...
-- DDL таблицы для отслеживания дат загрузки
